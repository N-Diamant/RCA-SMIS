		...
		<div id="banner">
			...
			<div class="right" style="position: relative;top: 50px; ">
				<c:if test="${authenticatedUser !=null}">
					<a href="createstudent.php?page=createstudent"><button class="btn btn-link" style="border: 1px lightslategray;color: aliceblue;background-color: #337AB7;padding: 10px;border-radius: 5px">
...
<%--									<td>Address Id</td>--%>
	...
	</div>	<div style="margin-left: 700px;color: #337AB7">
