    ...
    <body>
        <div id="layout" class="container" style="position: relative;top: 50px; ">
            <div id="banner">
                ...
                <div class="right" style="position: relative;top: 50px;">
                    <c:if test="${authenticatedUser !=null}">
                        <a href="createparent.php?page=createparent"><button class="btn btn-link" style="border: 1px lightslategray;color: aliceblue;background-color: #337AB7;padding: 10px;border-radius: 5px">
                    ...
                    <form action="listparents.php?page=statusapproval" method="post" class="form-group">
                        <div class="search" style="text-align: right; padding-top: 16px; ">
                            ...
                            <table class="table table-bordered">
                                <thead tyle="background-color: aliceblue">
                                    <tr>
                                        <td>ID</td>
                                        <td>Firstname</td>
                                        <td>Lastname</td>
