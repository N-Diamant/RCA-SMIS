            ...
            if(marks != null){
                ...
                try (OutputStream fos  = new FileOutputStream(file)){
                    for (Mark marks1: marks){
                        String marksScored = "Marks Scored: " + marks1.getCourseMarks();
                        String courseName = "Course Name : " + marks1.getCourseName();
                        String studentId = "Student Id: " + marks1.getStudentId() ;
